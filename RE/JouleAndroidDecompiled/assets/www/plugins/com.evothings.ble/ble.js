...
/** Gets Bluetooth Power Status.
*
* @example
evothings.ble.powerStatus();
*/
exports.powerStatus = function(win, fail) {
	exec(win, fail, 'BLE', 'powerStatus', []);
};
...
exports.readCharacteristic = function(deviceHandle, characteristicHandle, win, fail) {
	exec(function(data){
		...
		win(retVal)
	}, fail, 'BLE', 'readCharacteristic', [deviceHandle, characteristicHandle]);
};
...
* @param {number} deviceHandle - A handle from {@link connectCallback}.
* @param {number} characteristicHandle - A handle from {@link characteristicCallback}.
* @param {ArrayBuffer} data - The value to be written.
* @param {emptyCallback} win
* @param {failCallback} fail
* @example TODO: Add example.
*/
exports.writeCharacteristic = function(deviceHandle, characteristicHandle, data, win, fail) {
	exec(win, fail, 'BLE', 'writeCharacteristic', [deviceHandle, characteristicHandle, data]);
};
