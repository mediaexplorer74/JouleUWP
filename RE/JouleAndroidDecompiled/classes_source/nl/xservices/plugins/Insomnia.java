...
public class Insomnia extends CordovaPlugin {
    ...
    class C02171 implements Runnable {
        ...
        C02171(CallbackContext callbackContext) {
    ...
    class C02182 implements Runnable {
        ...
        C02182(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        try {
            if (ACTION_KEEP_AWAKE.equals(action)) {
                this.cordova.getActivity().runOnUiThread(new C02171(callbackContext));
                return true;
            } else if (ACTION_ALLOW_SLEEP_AGAIN.equals(action)) {
                this.cordova.getActivity().runOnUiThread(new C02182(callbackContext));
                return true;
            } else {
