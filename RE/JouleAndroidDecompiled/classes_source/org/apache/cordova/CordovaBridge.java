...
public class CordovaBridge {
    ...
    public String jsExec(int bridgeSecret, String service, String action, String callbackId, String arguments) throws JSONException, IllegalAccessException {
        ...
        try {
            ...
            e.printStackTrace();
            popAndEncode = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
            return popAndEncode;
        } finally {
    ...
    public String promptOnJsPrompt(String origin, String message, String defaultValue) {
        ...
        if (defaultValue != null && defaultValue.length() > 3 && defaultValue.startsWith("gap:")) {
            try {
                ...
                return r == null ? CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE : r;
            ...
            if (this.pluginManager.shouldAllowBridgeAccess(origin)) {
                ...
                return CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE + generateBridgeSecret();
            }
