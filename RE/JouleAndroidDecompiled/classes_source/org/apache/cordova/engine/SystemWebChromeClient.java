...
public class SystemWebChromeClient extends WebChromeClient {
    ...
    class C05781 implements Result {
        final /* synthetic */ JsResult val$result;

        C05781(JsResult jsResult) {
    ...
    class C05792 implements Result {
        final /* synthetic */ JsResult val$result;

        C05792(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C05803 implements Result {
        final /* synthetic */ JsPromptResult val$result;

        C05803(JsPromptResult jsPromptResult) {
    ...
    class C05814 extends CordovaPlugin {
        final /* synthetic */ ValueCallback val$uploadMsg;

        C05814(ValueCallback valueCallback) {
    ...
    class C05825 extends CordovaPlugin {
        final /* synthetic */ ValueCallback val$filePathsCallback;

        C05825(ValueCallback valueCallback) {
    ...
    public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
        this.dialogsHelper.showAlert(message, new C05781(result));
        return true;
    }

    public boolean onJsConfirm(WebView view, String url, String message, JsResult result) {
        this.dialogsHelper.showConfirm(message, new C05792(result));
        return true;
    }
    ...
    public boolean onJsPrompt(WebView view, String origin, String message, String defaultValue, JsPromptResult result) {
        ...
        if (handledRet != null) {
            ...
            this.dialogsHelper.showPrompt(message, defaultValue, new C05803(result));
        }
        return true;
    }
    ...
    public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
        ...
        intent.setType("*/*");
        this.parentEngine.cordova.startActivityForResult(new C05814(uploadMsg), intent, FILECHOOSER_RESULTCODE);
    }

    @TargetApi(21)
    public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathsCallback, FileChooserParams fileChooserParams) {
        try {
            this.parentEngine.cordova.startActivityForResult(new C05825(filePathsCallback), fileChooserParams.createIntent(), FILECHOOSER_RESULTCODE);
