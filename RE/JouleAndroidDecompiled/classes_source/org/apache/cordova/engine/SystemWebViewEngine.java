...
public class SystemWebViewEngine implements CordovaWebViewEngine {
    ...
    class C02672 extends BroadcastReceiver {
        ...
        C02672(WebSettings webSettings) {
    ...
    class C05831 implements OnlineEventsBridgeModeDelegate {
        C05831() {
        }
    ...
    public void init(CordovaWebView parentWebView, CordovaInterface cordova, Client client, CordovaResourceApi resourceApi, PluginManager pluginManager, NativeToJsMessageQueue nativeToJsMessageQueue) {
        ...
        initWebViewSettings();
        nativeToJsMessageQueue.addBridgeMode(new OnlineEventsBridgeMode(new C05831()));
    ...
    private void initWebViewSettings() {
        ...
        if (this.receiver == null) {
            this.receiver = new C02672(settings);
