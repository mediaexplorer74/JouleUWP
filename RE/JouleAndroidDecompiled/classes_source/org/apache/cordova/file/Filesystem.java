...
public abstract class Filesystem {
    ...
    protected static String normalizePath(String rawPath) {
        ...
        if (isAbsolutePath) {
            rawPath = rawPath.replaceFirst("/+", CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE);
        }
    ...
    protected LocalFilesystemURL makeDestinationURL(String newName, LocalFilesystemURL srcURL, LocalFilesystemURL destURL, boolean isDirectory) {
        if ("null".equals(newName) || CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE.equals(newName)) {
