...
public class NativeToJsMessageQueue {
    ...
    public static class LoadUrlBridgeMode extends BridgeMode {
        ...
        class C02441 implements Runnable {
            ...
            C02441(NativeToJsMessageQueue nativeToJsMessageQueue) {
        ...
        public void onNativeToJsMessageAvailable(NativeToJsMessageQueue queue) {
            this.cordova.getActivity().runOnUiThread(new C02441(queue));
        }
    }
    ...
    public static class OnlineEventsBridgeMode extends BridgeMode {
        ...
        class C02462 implements Runnable {
            ...
            C02462(NativeToJsMessageQueue nativeToJsMessageQueue) {
                this.val$queue = nativeToJsMessageQueue;
            }
        ...
        public void reset() {
            this.delegate.runOnUiThread(new C02451());
        }

        public void onNativeToJsMessageAvailable(NativeToJsMessageQueue queue) {
            this.delegate.runOnUiThread(new C02462(queue));
        }
