...
class SearchViewCompatHoneycomb {
    ...
    static class C01101 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01101(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01112 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01112(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
