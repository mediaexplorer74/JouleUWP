...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilterClient {
    ...
    void init(Context context, Cursor c, int flags) {
        ...
        this.mRowIDColumn = cursorPresent ? c.getColumnIndexOrThrow(MessagingSmsConsts.ID) : -1;
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            this.mRowIDColumn = newCursor.getColumnIndexOrThrow(MessagingSmsConsts.ID);
    ...
    public CharSequence convertToString(Cursor cursor) {
        return cursor == null ? CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE : cursor.toString();
    }
