...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C00402 implements Runnable {
        ...
        C00402(String str, Bundle bundle) {
    ...
    private class ServiceImpl {
        ...
        class C00411 implements Runnable {
            ...
            C00411(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00422 implements Runnable {
            ...
            C00422(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00433 implements Runnable {
            ...
            C00433(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C00444 implements Runnable {
            ...
            C00444(ServiceCallbacks serviceCallbacks, String str, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$options = bundle;
            }
        ...
        class C00455 implements Runnable {
            ...
            C00455(String str, ResultReceiver resultReceiver) {
        ...
        class C00466 implements Runnable {
            ...
            C00466(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00411(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00422(callbacks));
        }

        public void addSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00433(callbacks, id, options));
        }

        public void removeSubscription(String id, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00444(callbacks, id, options));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00455(mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00466(callbacks));
        }
    }

    /* renamed from: android.support.v4.media.MediaBrowserServiceCompat.3 */
    class C05043 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C05043(Object debug, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C05054 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C05054(Object debug, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(debug);
        }
    ...
    class MediaBrowserServiceImplApi23 implements MediaBrowserServiceImpl {
        ...
        public void onCreate() {
            ...
            MediaBrowserServiceCompatApi21.onCreate(this.mServiceObj, new ServiceImplApi23(null));
        }
    ...
    class MediaBrowserServiceImplApi24 implements MediaBrowserServiceImpl {
        ...
        public void onCreate() {
            ...
            MediaBrowserServiceCompatApi21.onCreate(this.mServiceObj, new ServiceImplApi24(null));
        }
    ...
    private class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class C05061 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            C05061(Handler handler, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String mediaId, ItemCallback cb) {
            this.mServiceImpl.getMediaItem(mediaId, new C05061(MediaBrowserServiceCompat.this.mHandler, cb));
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00391(token));
        }
    }
    ...
    private void notifyChildrenChangedInternal(String parentId, Bundle options) {
        ...
        this.mHandler.post(new C00402(parentId, options));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C05043(parentId, connection, parentId, options);
        if (options == null) {
            onLoadChildren(parentId, result);
        } else {
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C05054(itemId, receiver);
