...
public class FragmentActivity extends BaseFragmentActivityApi24 implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
        ...
        if (id != -1) {
            ...
            if (!(id == 0 || r == null)) {
                ...
                switch (ViewCompat.MEASURED_STATE_MASK & id) {
                    case PageTransition.FORWARD_BACK /*16777216*/:
                        pkgname = PushConstants.ANDROID;
                        break;
                    case 2130706432:
                        pkgname = AndroidProtocolHandler.APP_SCHEME;
                        break;
                    default:
                        try {
