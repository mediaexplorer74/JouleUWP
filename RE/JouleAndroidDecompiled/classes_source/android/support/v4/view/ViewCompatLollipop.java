...
class ViewCompatLollipop {
    ...
    static class C00871 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListener val$listener;

        C00871(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener listener) {
        if (listener == null) {
            ...
            view.setOnApplyWindowInsetsListener(new C00871(listener));
        }
    }
