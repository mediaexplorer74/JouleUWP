...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C05181 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05181() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C05181());
        }
    ...
    class C05174 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == WebInputEventModifier.IsRight && ViewPager.this.mAdapter != null) {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction((int) WebInputEventModifier.IsRight);
            }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00881();
        sInterpolator = new C00892();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00903();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05174());
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            int makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), PageTransition.CLIENT_REDIRECT);
                            child.measure(widthSpec, MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, PageTransition.CLIENT_REDIRECT));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        int action = ev.getAction() & PageTransition.CORE_MASK;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            if (this.mAdapter.getCount() != 0) {
                ...
                float x;
                switch (action & PageTransition.CORE_MASK) {
                    case SCROLL_STATE_IDLE /*0*/:
                        this.mScroller.abortAnimation();
                        this.mPopulatePending = DEBUG;
                        populate();
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(PointerIconCompat.STYLE_DEFAULT, (float) this.mMaximumVelocity);
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == WebInputEventModifier.IsRight) {
