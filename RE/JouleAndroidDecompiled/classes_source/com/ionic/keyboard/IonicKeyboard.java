...
public class IonicKeyboard extends CordovaPlugin {
    ...
    class C02081 implements OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            int pixelHeightDiff = (int) (((float) (this.val$rootView.getRootView().getHeight() - r.bottom)) / this.val$density);
    ...
    class C02092 implements Runnable {
        ...
        C02092(CallbackContext callbackContext) {
    ...
    class C02103 implements Runnable {
        ...
        C02103(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        rootView.getViewTreeObserver().addOnGlobalLayoutListener(new C02081(rootView, density, appView));
    }

    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if ("close".equals(action)) {
            this.cordova.getThreadPool().execute(new C02092(callbackContext));
            return true;
        } else if (!"show".equals(action)) {
            return false;
        } else {
            this.cordova.getThreadPool().execute(new C02103(callbackContext));
            return true;
        }
    }
}
