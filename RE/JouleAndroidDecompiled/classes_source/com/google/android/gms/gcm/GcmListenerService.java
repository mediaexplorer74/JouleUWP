...
public abstract class GcmListenerService extends Service {
    ...
    class C01601 implements Runnable {
        ...
        C01601(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C01612 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzaLA;

        C01612(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaLA = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    private void zzn(Intent intent) {
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C01601(this, intent));
        } else {
            new C01612(this, intent).execute(new Void[0]);
        }
    }
    ...
    private void zzq(Intent intent) {
        ...
        String string = extras.getString(PushConstants.FROM);
