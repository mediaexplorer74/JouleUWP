...
public class GoogleCloudMessaging {
    ...
    class C01621 extends Handler {
        ...
        C01621(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaLU = new Messenger(new C01621(this, Looper.getMainLooper()));
    }
    ...
    private String zzdZ(String str) {
        ...
        return InstanceID.getInstance(this.context).zzyB().zzi(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE, str, INSTANCE_ID_SCOPE);
    }
