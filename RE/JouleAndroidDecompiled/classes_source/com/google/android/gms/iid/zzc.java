...
public class zzc {
    ...
    class C01701 extends Handler {
        ...
        C01701(zzc com_google_android_gms_iid_zzc, Looper looper) {
    ...
    private void zzea(String str) {
        if ("com.google.android.gsf".equals(zzaNg)) {
            ...
            if (this.zzaNp >= 3) {
                if (this.zzaNp == 3) {
                    this.zzaNq = new Random().nextInt(PointerIconCompat.STYLE_DEFAULT) + PointerIconCompat.STYLE_DEFAULT;
                }
                this.zzaNq *= 2;
    ...
    synchronized void zzt(Intent intent) {
        ...
        intent.putExtra(AndroidProtocolHandler.APP_SCHEME, this.zzaLQ);
    }
    ...
    void zzv(Intent intent) {
        ...
        if (longExtra > 0) {
            ...
            this.zzaNq = ((int) longExtra) * PointerIconCompat.STYLE_DEFAULT;
            this.zzaNr = SystemClock.elapsedRealtime() + ((long) this.zzaNq);
    ...
    void zzyE() {
        if (this.zzaLU == null) {
            zzaN(this.context);
            this.zzaLU = new Messenger(new C01701(this, Looper.getMainLooper()));
        }
    }
}
