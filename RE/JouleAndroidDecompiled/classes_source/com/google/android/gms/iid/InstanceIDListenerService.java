...
public class InstanceIDListenerService extends Service {
    ...
    class C01671 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C01671(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C01682 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C01682(InstanceIDListenerService instanceIDListenerService) {
            this.zzaNc = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaMW = new MessengerCompat(new C01671(this, Looper.getMainLooper()));
        this.zzaMX = new C01682(this);
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        try {
            ...
            stop();
            if (intent.getStringExtra(PushConstants.FROM) != null) {
    ...
    public void zzp(Intent intent) {
        ...
        if (intent.getStringExtra("error") == null && intent.getStringExtra("registration_id") == null) {
            ...
            if (intent.getStringExtra("unregistered") != null) {
                ...
                if (stringExtra == null) {
                    stringExtra = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
                }
                zzyB.zzef(stringExtra);
                instance.zzyC().zzw(intent);
                return;
            } else if (zzaLH.equals(intent.getStringExtra(PushConstants.FROM))) {
