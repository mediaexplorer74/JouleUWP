...
public class InstanceID {
    ...
    protected InstanceID(Context context, String subtype, Bundle options) {
        this.zzaMT = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
    ...
    public static synchronized InstanceID zza(Context context, Bundle bundle) {
        ...
        synchronized (InstanceID.class) {
            String string = bundle == null ? CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE : bundle.getString("subtype");
            String str = string == null ? CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE : string;
    ...
    static String zza(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & 15) + 112) & PageTransition.CORE_MASK);
    ...
    public String getToken(String authorizedEntity, String scope, Bundle extras) throws IOException {
        ...
        if (zzi == null) {
            ...
            if (!"jwt".equals(extras.getString(MessagingSmsConsts.TYPE))) {
                obj = obj2;
            }
    ...
    public void zzb(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("subtype", CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE.equals(this.zzaMT) ? str : this.zzaMT);
        String str3 = "X-subtype";
        if (!CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE.equals(this.zzaMT)) {
            str = this.zzaMT;
        }
    ...
    public String zzc(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("sender", str);
        String str3 = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE.equals(this.zzaMT) ? str : this.zzaMT;
    ...
    boolean zzyD() {
        String str = zzaMQ.get(JsonField.AppVersion);
