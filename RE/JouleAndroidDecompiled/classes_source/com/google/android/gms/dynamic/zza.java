...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C05531 implements zzf<T> {
        final /* synthetic */ zza zzavB;

        C05531(zza com_google_android_gms_dynamic_zza) {
    ...
    class C05542 implements zza {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ zza zzavB;
        final /* synthetic */ Bundle zzavC;
        final /* synthetic */ Bundle zzavD;

        C05542(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzavB = com_google_android_gms_dynamic_zza;
    ...
    class C05553 implements zza {
        final /* synthetic */ zza zzavB;
        final /* synthetic */ Bundle zzavD;

        C05553(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzavB = com_google_android_gms_dynamic_zza;
            this.zzavD = bundle;
        }
    ...
    class C05564 implements zza {
        ...
        C05564(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzavB = com_google_android_gms_dynamic_zza;
    ...
    class C05576 implements zza {
        final /* synthetic */ zza zzavB;

        C05576(zza com_google_android_gms_dynamic_zza) {
            this.zzavB = com_google_android_gms_dynamic_zza;
        }
    ...
    class C05587 implements zza {
        final /* synthetic */ zza zzavB;

        C05587(zza com_google_android_gms_dynamic_zza) {
            this.zzavB = com_google_android_gms_dynamic_zza;
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        zza(savedInstanceState, new C05553(this, savedInstanceState));
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FrameLayout frameLayout = new FrameLayout(inflater.getContext());
        zza(savedInstanceState, new C05564(this, frameLayout, inflater, container, savedInstanceState));
        if (this.zzavx == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle attrs, Bundle savedInstanceState) {
        zza(savedInstanceState, new C05542(this, activity, attrs, savedInstanceState));
    }
