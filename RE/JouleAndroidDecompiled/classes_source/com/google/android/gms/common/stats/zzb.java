...
public class zzb {
    ...
    private zzb() {
        ...
        this.zzanu = new zze(WebInputEventModifier.NumLockOn, ((Long) zza.zzanE.get()).longValue());
        this.zzanw = new zze(WebInputEventModifier.NumLockOn, ((Long) zza.zzanE.get()).longValue());
    }
