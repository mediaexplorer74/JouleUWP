...
public final class WakeLockEvent extends zzf implements SafeParcelable {
    ...
    public String zzrO() {
        return "\t" + zzrR() + "\t" + zzrT() + "\t" + (zzrU() == null ? CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE : TextUtils.join(",", zzrU())) + "\t" + zzrV() + "\t" + (zzrS() == null ? CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE : zzrS()) + "\t" + (zzrW() == null ? CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE : zzrW()) + "\t" + zzrX();
    }
