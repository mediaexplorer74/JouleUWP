...
public class GoogleApiAvailability extends zzc {
    ...
    public Dialog zza(Activity activity, OnCancelListener onCancelListener) {
        ...
        builder.setMessage(activity.getResources().getString(C0143R.string.common_google_play_services_updating_text, new Object[]{zzao}));
        builder.setTitle(C0143R.string.common_google_play_services_updating_title);
        builder.setPositiveButton(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE, null);
