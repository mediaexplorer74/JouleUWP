...
public class zzd extends zzy {
    ...
    static {
        zzaVA = String.valueOf(zzc.GOOGLE_PLAY_SERVICES_VERSION_CODE / PointerIconCompat.STYLE_DEFAULT).replaceAll("(\\d+)(\\d)(\\d\\d)", "$1.$2.$3");
    }
    ...
    int zzBE() {
        return WebTextInputFlags.AutocapitalizeWords;
    }
    ...
    public int zzBG() {
        return WebInputEventModifier.IsLeft;
    }
    ...
    public long zzBp() {
        return (long) (zzc.GOOGLE_PLAY_SERVICES_VERSION_CODE / PointerIconCompat.STYLE_DEFAULT);
    }
    ...
    public String zzH(String str, String str2) {
        ...
        builder.scheme((String) zzl.zzaWe.get()).authority((String) zzl.zzaWf.get()).path("config/app/" + str).appendQueryParameter("app_instance_id", str2).appendQueryParameter("platform", PushConstants.ANDROID).appendQueryParameter("gmp_version", String.valueOf(zzBp()));
