...
public final class AppMeasurementService extends Service {
    ...
    class C01751 implements Runnable {
        ...
        class C01741 implements Runnable {
            final /* synthetic */ C01751 zzaTZ;

            C01741(C01751 c01751) {
                this.zzaTZ = c01751;
            }
        ...
        C01751(AppMeasurementService appMeasurementService, zzw com_google_android_gms_measurement_internal_zzw, int i, zzp com_google_android_gms_measurement_internal_zzp) {
        ...
        public void run() {
            this.zzaTW.zzDc();
            this.zzaTY.mHandler.post(new C01741(this));
        }
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zzaT.zzCn().zzg(new C01751(this, zzaT, startId, zzAo));
        }
        return 2;
    }
