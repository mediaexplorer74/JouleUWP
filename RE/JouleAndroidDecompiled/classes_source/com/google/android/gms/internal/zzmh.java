...
public final class zzmh implements zzmg {
    ...
    class C06831 extends zza {
        final /* synthetic */ zzmh zzamB;

        C06831(zzmh com_google_android_gms_internal_zzmh, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzf(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C06831(this, googleApiClient));
    }
}
