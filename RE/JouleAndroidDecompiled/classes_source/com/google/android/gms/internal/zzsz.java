...
public interface zzsz {
    ...
    public static final class zzb extends zzso<zzb> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.zzbuN.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE)) {
                output.zzn(2, this.zzbuN);
            }
            if (!this.version.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE)) {
        ...
        public zzb zzJD() {
            this.zzbuM = 0;
            this.zzbuN = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
            this.version = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
            this.zzbuj = null;
            this.zzbuu = -1;
            return this;
        }
        ...
        protected int zzz() {
            ...
            return !this.version.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE) ? zzz + zzsn.zzo(3, this.version) : zzz;
        }
    }
    ...
    public static final class zzd extends zzso<zzd> {
        ...
        public void writeTo(zzsn output) throws IOException {
            ...
            if (!this.tag.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE)) {
            ...
            if (!this.zzbvc.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE)) {
        ...
        public zzd zzJF() {
            ...
            this.zzbvb = null;
            this.zzbvc = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
            this.zzbvd = 180000;
            this.zzbve = null;
    ...
    public static final class zze extends zzso<zze> {
        ...
        public void writeTo(zzsn output) throws IOException {
            if (!this.key.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE)) {
                output.zzn(1, this.key);
            }
            if (!this.value.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE)) {
        ...
        public zze zzJH() {
            this.key = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
            this.value = CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE;
            this.zzbuj = null;
            this.zzbuu = -1;
            return this;
        }
        ...
        protected int zzz() {
            ...
            return !this.value.equals(CaptioningChangeDelegate.DEFAULT_CAPTIONING_PREF_VALUE) ? zzz + zzsn.zzo(2, this.value) : zzz;
        }
    }
}
