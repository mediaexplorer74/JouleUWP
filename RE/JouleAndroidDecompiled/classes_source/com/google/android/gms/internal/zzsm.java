...
public final class zzsm {
    ...
    private zzsm(byte[] bArr, int i, int i2) {
        ...
        this.zzbug = 64;
        this.zzbuh = PageTransition.HOME_PAGE;
        this.buffer = bArr;
        this.zzbtZ = i;
        this.zzbua = i + i2;
        this.zzbuc = i;
    ...
    public int zzJh() throws IOException {
        return (((zzJm() & PageTransition.CORE_MASK) | ((zzJm() & PageTransition.CORE_MASK) << 8)) | ((zzJm() & PageTransition.CORE_MASK) << 16)) | ((zzJm() & PageTransition.CORE_MASK) << 24);
    }
