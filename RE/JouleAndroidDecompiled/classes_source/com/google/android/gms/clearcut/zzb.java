...
public final class zzb {
    ...
    public static class zzc {
        public long zzC(long j) {
            return (long) (TimeZone.getDefault().getOffset(j) / PointerIconCompat.STYLE_DEFAULT);
        }
    }

    /* renamed from: com.google.android.gms.clearcut.zzb.1 */
    static class C05291 extends com.google.android.gms.common.api.Api.zza<zzlw, NoOptions> {
        C05291() {
        }
